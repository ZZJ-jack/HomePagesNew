const config = {
	...
	projectcards: [
		...
		{ go: "前往", img: "/img/Just-Solo.png", title: "Just-Solo", subtitle: "Just-Solo音乐播放器", text: "Just-Solo，一个高性能、低占用的音乐播放器", url: "https://gitcode.com/ZZJ-JACK/Just-Solo", show: false },
		...
		{ go: "前往", img: "/img/gitee-logo.jpg", title: "Gitee代码获取", subtitle: "获取luogu的AC代码", text: "本工具会在Gitee上获取luogu的AC代码", url: "https://getzsyzcode.zzjjack.us.kg", show: false },
	],
